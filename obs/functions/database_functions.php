...
$connectionInfo = array("UID" => "basidhahamed", "pwd" => "{your_password_here}", "Database" => "onlinbookstore", "LoginTimeout" => 30, "Encrypt" => 1, "TrustServerCertificate" => 0);
$serverName = "tcp:online-bookstore.database.windows.net,1433";
